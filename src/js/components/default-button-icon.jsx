...
export class DefaultButtonIconComponent extends Component {
    static propTypes = {
        isSparkcentralColorDark: PropTypes.bool.isRequired,
        location: PropTypes.object.isRequired
    };

    render() {
        const {isSparkcentralColorDark, location} = this.props;
        ...
        return <svg version='1.0'
                   ...
                   <path fill={ isSparkcentralColorDark ? '#fff' : SK_DARK_CONTRAST }
