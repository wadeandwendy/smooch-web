...
describe('ReplyActions Component', () => {
    ...
    it('should render choices', () => {
        TestUtils.scryRenderedDOMComponentsWithClass(component, 'btn-CLASS_PREFIX-reply-action').forEach((node, index) => {
            ...
            if (choice.type === 'locationRequest') {
                ...
                TestUtils.scryRenderedDOMComponentsWithClass(component, 'CLASS_PREFIX-location-icon').length.should.be.eq(1);
