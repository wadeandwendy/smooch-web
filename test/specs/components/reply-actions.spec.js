...
describe('ReplyActions Component', () => {
    ...
    it('should render choices', () => {
        TestUtils.scryRenderedDOMComponentsWithClass(component, 'btn-spark-reply-action').forEach((node, index) => {
            ...
            if (choice.type === 'locationRequest') {
                ...
                TestUtils.scryRenderedDOMComponentsWithClass(component, 'spark-location-icon').length.should.be.eq(1);
